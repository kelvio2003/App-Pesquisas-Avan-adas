...
<h5 class="event-title"><?php echo e($eventos->titolo); ?></h5>

<p class="card-date"><?php echo e($eventos->descricao); ?></p>
<p class="card-date"><?php echo e($eventos->data); ?></p>
<p class="card-participants"><?php echo e($eventos->local); ?> </p>
<p class="card-participants"><?php echo e($eventos->criador); ?> </p>

<?php $__currentLoopData = $eventos->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\laravel\Projecto_starsoft\resources\views/ver.blade.php ENDPATH**/ ?>